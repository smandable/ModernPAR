...
> Status: **Phases 0–9 complete — fully native, no Rosetta anywhere; v1.1.0 shipped.**
...
> is arm64-only (CI-gated, including the embedded Sparkle 2). 438 tests, including byte-for-byte
> oracle checks against the original tools and license-compliance gates. The signing /
> notarization / Sparkle / DMG pipeline is live: **v1.1.0 is the latest release** — a
